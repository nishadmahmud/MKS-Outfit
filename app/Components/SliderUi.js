                ...
                return (
                  <SwiperSlide key={idx} className="relative w-full h-full">
                    <Link href={productLink}>
                      ...
                      />
                      <div className="absolute bottom-4 left-4 bg-black/20 poppins border border-white text-white px-10 py-2 rounded-full text-sm font-medium shadow-md backdrop-blur-sm flex items-center gap-2">
