  ...
  return (
    <div className="max-w-3xl mx-auto px-4 md:pt-32 pt-20 py-10 text-gray-800">
      ...
      <p className="text-center text-gray-600 mb-6">
        <span className="font-semibold">Mks Outfit</span> proudly offers original export-quality men’s fashion products. 
      ...
      <div className="flex flex-col items-center gap-2 text-lg font-medium">
        <p>📞 Customer Service: <a href="tel:+8801737332432" className="text-blue-600 underline">+8801737332432</a></p>
        <p>🌐 Website: <a href="https://www.mksoutfit.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">www.mksoutfit.com</a></p>
      </div>

      <p className="text-center mt-8 text-sm italic text-gray-500">
        Let Mks Outfit be your trusted partner in premium export fashion.
      </p>
    </div>
  );
}
